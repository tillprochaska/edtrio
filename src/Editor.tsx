      ...
      <div className="columns">
        ...
        <div className="column is-three-quarters">
          <div style={{ marginTop: "2rem" }}>
            {process.env.NODE_ENV === "development" || process.env.REACT_APP_SHOW_PREVIEW_BUTTON === "TRUE" ? (
              <StyledEditButton
                onClick={() =>
          ...
          {process.env.NODE_ENV === "development" || process.env.REACT_APP_SHOW_DOCUMENT_VALUE === "TRUE" ? (
